...
bind_opts = [
    ...
    cfg.IntOpt('bind_port', default='7667',
...
eventlet_opts = [
    cfg.IntOpt('workers', default=utils.get_worker_count(),
...
class Server(object):
    ...
    def start(self, application):
        ...
        pgid = os.getpid()
        try:
            # Make sure this process runs in its own process group.
        ...
        def register_action_override_cfg_opts():
        ...
        register_action_override_cfg_opts()
        self.application = application
        self.sock = _get_socket(CONF.bind_host, CONF.bind_port, CONF.backlog)
        self.logger = logging.getLogger('qonos.wsgi.server')
...
class Service(service.Service):
    ...
    def start(self):
        ...
        self._socket = _get_socket(self._host, self._port, self._backlog)
